<header>
    ...
    <div class="float-left">
        <div class="link inline text-center @if (Route::current()->getName() == 'thrust.index') active @endif "><a href="{{route('thrust.index', 'issues')}}">Issues</a></div>
        <div class="link inline text-center @if (Route::current()->getName() == 'thrust.index') active @endif "><a href="{{route('thrust.index', 'cycles')}}">Cycles</a></div>
